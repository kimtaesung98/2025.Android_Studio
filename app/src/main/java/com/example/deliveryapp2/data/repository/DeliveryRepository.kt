...
class MockDeliveryRepository : DeliveryRepository {
    ...
    private val mockOrders = mutableListOf(
        Order("101", "Burger King", listOf("Whopper Set"), 8900, OrderStatus.COOKING, "2023-10-25"),
        Order("102", "Pizza Hut", listOf("Cheese Pizza", "Coke"), 24000, OrderStatus.COMPLETED, "2023-10-24")
    )
